// Mirrored verbatim from src/StatisticsAnalysisTool/Network/EventCodes.cs (upstream WPF app).
// The enum ORDINAL is the Photon wire event code (parameter 252), so the order must match
// upstream exactly. Re-sync this file when upstream changes event codes (game patches).
